                ...
                <div class="col-lg-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ \Str::limit($admin->jobhigh, 50) }}</td>
                            <td>{{ \Str::limit($admin->jobdesc, 50) }}}</td>
                            <td>{{ \Str::limit ($admin->qualification, 50) }}</td>
                            <td>{{ \Str::limit($admin->competencies, 50) }}</td>
                            <td>{{ \Str::limit($admin->techskill, 50) }}</td>
                            <td>{{ \Str::limit($admin->additional, 50) }}</td>
                            <td>
